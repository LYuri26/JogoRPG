...
function createModalContent(character, data) {
  return `
      <div class="modal-header border-secondary">
          <h2 class="modal-title fs-3">${data.title}</h2>
              ...
              <div class="col-md-8">
                  <div class="row">
                      <div class="col-6 mb-3">
                          <div class="stat-box bg-dark-800 p-3 rounded">
                              <h4 class="h6 text-warning"><i class="fas fa-heart me-2"></i>Vida</h4>
                              <p class="h4 mb-0">${data.life}</p>
                          </div>
                      </div>
                      <div class="col-6 mb-3">
                          <div class="stat-box bg-dark-800 p-3 rounded">
                              <h4 class="h6 text-primary"><i class="fas fa-fist-raised me-2"></i>Dano</h4>
                              <p class="h4 mb-0">${data.damage}</p>
                          </div>
                      </div>
                      <div class="col-6 mb-3">
                          <div class="stat-box bg-dark-800 p-3 rounded">
                              <h4 class="h6 text-info"><i class="fas fa-shield-alt me-2"></i>Armadura</h4>
                  ...
                  <div class="special-ability bg-dark-800 p-3 rounded mb-3">
                      <h3 class="h5 text-warning"><i class="fas fa-fire me-2"></i>Habilidade Especial</h3>
                      <p class="mb-2">${data.specialDice}</p>
                      <p class="mb-1"><strong>Custo:</strong> <span class="badge bg-danger">${
                        data.cost
                      }</span></p>
                      <p class="mb-0"><strong>Penalidade:</strong> <span class="badge bg-secondary">${
                        data.penalty
                      }</span></p>
                  </div>
              </div>
